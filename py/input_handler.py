...
def detect_columns(headers):
    ...
    return smiles_col, id_col, source_col
    ...
    with open(args.out_smi, "w") as out_smi, open(args.id_map, "w") as map_file:
        ...
        # ------------------------------------------------------------
            ...
            with open(args.input) as f:
                ...
                smiles_col, id_col, source_col = detect_columns(headers)
                ...
                for i, row in enumerate(reader):
                    ...
                    try:
                        ...
                        # Preserve existing source if available
                        if source_col:
                            source = str(row.get(source_col, "")).strip() or "Custom"
